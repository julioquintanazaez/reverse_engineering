...
from ..serializers.testserializer import TestCreateSerializer, TestSerializer
...
class UserTestResultsView(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        return Test.objects.filter(user_code=user_code)
...
class TestResultSearchView(APIView):
    ...
    def get(self, request):
        ...
        results = Test.objects.filter(query)
        serializer = TestSerializer(results, many=True)
